...
def generate_plots(results, config):
    ...
    ax1 = axes[0]
    ax1.plot(df.index, df['sup'], label='Primary Supply Temp', color='#e74c3c', linewidth=1.5, alpha=0.8)
    ax1.plot(df.index, df['ret'], label='Primary Return Temp', color='#3498db', linewidth=1.5, alpha=0.8)
    ax1.set_ylabel('Temperature (°C)', fontsize=12, fontweight='bold')
    ax1.set_title('Primary Loop: Supply and Return Temperature Over Time', fontsize=14, fontweight='bold')
    ...
    ax2.set_title('Primary Loop: Temperature Differential Over Time', fontsize=14, fontweight='bold')
    ...
    axes[0].set_title('Primary Loop: Distribution of Temperature Differential', fontsize=12, fontweight='bold')
    ...
    axes[1, 1].set_title('Primary Loop: Supply vs Return Temperature', fontsize=12, fontweight='bold')
    ...
    ax.set_title('Primary Loop: Temperature Differential Heatmap (Hour vs Day of Week)', fontsize=14, fontweight='bold')
